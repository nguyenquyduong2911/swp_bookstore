...
private String generateCategoryItemsHtml(List<book_show> bookList) {
    ...
    for (book_show book : bookList) {
        ...
        htmlBuilder.append("<a href=\"productdetail?productid=").append(book.getId()).append("\" class=\"btn btn-default add-to-cart\"><i class=\"fa fa-shopping-cart\"></i>Add to cart</a>");
